...
const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center bg-gradient-to-r from-pink-200 via-purple-200 to-indigo-200text-base-content rounded p-10 shadow-sm">
